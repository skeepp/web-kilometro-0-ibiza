            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-10 md:gap-12 mb-12 text-center md:text-left">
                    <div className="md:col-span-2">
                        ...
                        <p className="text-brand-background/80 max-w-sm mx-auto md:mx-0">
                            Conectamos productores locales de Baleares con consumidores que buscan producto real, trazable y de kilómetro cero.
                        </p>
                    </div>
                ...
                <div className="border-t border-white/20 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-white/70 text-center md:text-left">
